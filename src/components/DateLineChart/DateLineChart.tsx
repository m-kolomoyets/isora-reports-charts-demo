...
import { getLinesConfig, xAxisTickFormatter, yAxisTickFormatter } from './utils/common';
        ...
        <div className={clsx(s.wrap, className)}>
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    />
                    <YAxis type="number" axisLine={false} tickLine={false} tickCount={6} tick={yAxisTickFormatter} />
                    <Tooltip
